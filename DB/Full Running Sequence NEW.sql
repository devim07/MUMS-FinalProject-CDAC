...
CALL OLD_ORDER_ENTRY(4,350,'2022-06-10','DELIVERED','9');
CALL OLD_ORDER_ENTRY(2,500,'2022-06-11','DELIVERED','10');
...
CALL OLD_ORDER_ENTRY(6,650,'2022-07-10','DELIVERED', '17,18');
CALL OLD_ORDER_ENTRY(9,400,'2022-07-16','DELIVERED', '18,19');
CALL OLD_ORDER_ENTRY(7,600,'2022-07-19','DELIVERED', '19,20');
CALL OLD_ORDER_ENTRY(2,600,'2022-07-21','DELIVERED', '20,21');
CALL OLD_ORDER_ENTRY(4,650,'2022-07-25','DELIVERED', '21,22');

CALL OLD_ORDER_ENTRY(9,750,'2022-08-02','DELIVERED', '23,24');
CALL OLD_ORDER_ENTRY(7,550,'2022-08-07','DELIVERED', '24');
CALL OLD_ORDER_ENTRY(3,300,'2022-08-07','DELIVERED', '25,26');
