...
INSERT INTO EMP (ENUM, ENAME, BASIC_SAL, DEPTNO, JOB, CITY, EMAIL, HIREDATE) VALUES
('F001', 'ABHISHEK KUMAR BHAGAUS', 34000, 'F', 'M', 'BOMB', 'ABHISHEK@GMAIL.COM', '1988-09-21'),
('F002', 'HRISHIK SUDHIR SHETTY', 30000, 'F', 'S', 'BOMB', 'HRISHIK@GMAIL.COM', '1991-08-25'),
('F003', 'MASIRA SHAIKH', 25000, 'F', 'W', 'BOMB', 'MASIRA@GMAIL.COM', '1998-09-21'),
('F004', 'SANDEEP RAMPRAKASH SAHU', 22000, 'F', 'W', 'BOMB', 'SANDEEP@GMAIL.COM', '2004-11-1'),
('R001', 'SHRIRAM RAMADEVI IYER', 34000, 'R', 'M', 'BOMB', 'SHRIRAM@GMAIL.COM', '1999-12-11'),
('R002', 'VIJAYALAKSHMI IYER', 31000, 'R', 'S', 'BOMB', 'VIJAYALAKSHMI@GMAIL.COM', '2006-7-27'),
('R003', 'PALLAVI BAKALE', 25000, 'R', 'W', 'PUNE', 'PALLAVI@GMAIL.COM', '2010-4-1'),
('R004', 'SAIRAJ VINAYAK HEGISHTE', 21000, 'R', 'W', 'BOMB', 'SAIRAJ@GMAIL.COM', '2015-05-19'),
('P001', 'VASNAT NADAR', 32000, 'P', 'M', 'BOMB', 'VASNAT@GMAIL.COM', '1992-05-19'),
('P002', 'NADAR BALAJI SHAKTIVEL', 23000, 'P', 'S', 'BOMB', 'BALAJI@GMAIL.COM', '1997-04-18'),
('P003', 'ROHAN JANARDAN CHAVAN', 20000, 'P', 'W', 'BOMB', 'ROHAN@GMAIL.COM', '2004-03-29'),
('P004', 'SINGH ADITYA SUGREEV', 19000, 'P', 'W', 'BOMB', 'ADITYA@GMAIL.COM', '2010-09-8'),
('P005', 'SUMEET SURESH PILLAI', 18000, 'P', 'W', 'BOMB', 'SUMEET@GMAIL.COM', '2015-09-21'),
('S001', 'SOHAM BALAKRISHNAN K', 34000, 'S', 'M', 'BOMB', 'SOHAM@GMAIL.COM', '1990-09-20'),
('S002', 'SOHAN VISHNU GOWDA', 21000, 'S', 'W', 'BOMB', 'SOHAN@GMAIL.COM', '2010-08-10'),
('S003', 'RITESH MAHESH SHIKNE', 20000, 'S', 'W', 'PUNE', 'RITESH@GMAIL.COM', '2012-1-11'),
('S004', 'MARTINRAJ JOHNRAJ NADAR', 20000, 'S', 'W', 'NAGP', 'MARTINRAJ@GMAIL.COM', '2016-09-13'),
('S005', 'KALPESH JOTIBA PATIL', 19000, 'S', 'W', 'DELH', 'KALPESH@GMAIL.COM', '2017-02-15'),
('S006', 'JABIN JAGADEESAN NADAR', 18500, 'S', 'W', 'CHEN', 'JABIN@GMAIL.COM', '2018-7-23'),
('S007', 'CHAITANYA ABHAY GHATKAR', 17000, 'S', 'W', 'BEED', 'CHAITANYA@GMAIL.COM', '2019-5-2');

INSERT INTO EMP_DETAILS (ENUM, MOB, GEN, AADHAR, DOB, CITY, PINCODE, ADDRESS) VALUES
('F001', 9986995765,'M', 123456788765, '1971-07-23', 'BOMB', 400622, '29/SHWETAMBARI APT, BHATWADI, THANE'),
('F002', 9869989658,'M', 113456788765, '1975-01-30', 'BOMB', 400612, '12/SAI SADAN, KISSAN NAGAR, BHATWADI, THANE'),
('F003', 9989995765,'F', 552356788765, '1980-12-3', 'BOMB', 401620, 'B-64/KRANTI TOWERS, NARIMAN POINT, MUMBAI'),
('F004', 8069995765,'M', 623456778769, '1984-07-23', 'BOMB', 400611, '490  Wafa Chs Laxmibe Cheda Marg Nalasopara, Pune'),
('R001', 8890095765,'M', 671459978769, '1973-08-13', 'BOMB', 400641, 'Ground Floor 56 Nagdevi St Mandvi, Mumbai'),
('R002', 8891695700,'F', 771454978669, '1981-08-11', 'BOMB', 401641, '234  S.v.road Opp. Railway Station Andheri, Mumbai'),
('R003', 8199987657,'F', 451453478721, '1987-09-2', 'PUNE', 400600, '49  Wafa Chs Laxmibe Cheda Marg Nalasopara, Pune'),
('R004', 9099095765,'M', 311359998759, '1988-01-11', 'BOMB', 400631, 'Mittal Chambers Yogakshema , Mumbai'),
('P001', 9833095765,'M', 119889998759, '1966-01-17', 'BOMB', 403631, 'D-302 Ttc Indl Area Turbhe Naka Turbhe, Mumbai'),
('P002', 9837895765,'M', 341259998009, '1975-01-31', 'BOMB', 400630, 'W-258257256 Midc Phase Ii Shivaji Udyog Nagar Dombivli, Mumbai'),
('P003', 8003095700,'M', 711259998899, '1986-09-19', 'BOMB', 400689, 'Jabbar Complex Begumpet, Hyderabad,Mumbai'),
('P004', 9038995787,'M', 321259998567, '1988-07-1', 'BOMB', 401006, '28  Western Highway Sativali Vasai , Mumbai'),
('P005', 8102395787,'M', 561259788346, '1994-01-12', 'BOMB', 400026, '104  Sarang Street Near Crawford Market Mandvi'),
('S001', 8882395788,'M', 781259788721, '1994-01-12', 'BOMB', 402026, '2/3 Shri Gurudutta Krupa Chs R B Mehta Road Patel Chowk Near Rly Station, THANE'),
('S002', 9702394487,'M', 568759783456, '1994-01-12', 'BOMB', 401121, '424  Plot No  Persipolis Prem Sec  Vashi Navi Mumbai'),
('S003', 7920211781,'M', 432259788711, '1994-01-12', 'PUNE', 401025, '42 -b-c Mahavir Bldg Navneet Showroom Bhandark Matunga,PUNE'),
('S004', 8202300001,'M', 761259788123, '1994-01-12', 'NAGP', 401111, '420 -b-c Mahavir Bldg Navneet Showroom Bhandark Matunga,Nagpur'),
('S005', 8802225722,'M', 566549788541, '1994-01-12', 'DELH', 401012, '40   Khetwadi Main Road Dr Bhajekar Street Behind Harkisandas Hospital Khetwadi, DELHI'),
('S006', 7602393181,'M', 331259788776, '1994-01-12', 'CHEN', 401113, '156  Opp Remson Co Ganesh Nagar Charkop Kandivli, CHENNAI'),
('S007', 7502395745,'M', 560259788709, '1994-01-12', 'BEED', 401020, 'Jabbar Complex Begumpet, Beed');
...
('MAHESH RADAR','NAGP',8765797821, 8);
...
CALL CUST_SALESMAN_ALLOCATION(9);
...
(
	HEAD CHAR(1)
    CONSTRAINT CH_INCM_EXP_TALLY_HEAD CHECK (HEAD IN ('I', 'E', 'P', 'L','T', 'X')),
    AMT FLOAT,
    ENTRY_DATE DATETIME,
    REMARK VARCHAR(200) 
);
...
CALL OLD_ORDER_ENTRY(3,250,'2022-05-01','DELIVERED','1');
CALL OLD_ORDER_ENTRY(1,500,'2022-05-15','DELIVERED','1,2');
CALL OLD_ORDER_ENTRY(2,450,'2022-05-21','DELIVERED','2,3');
CALL OLD_ORDER_ENTRY(7,700,'2022-05-22','DELIVERED','3,4');
CALL OLD_ORDER_ENTRY(8,300,'2022-05-22','DELIVERED','4,5');
CALL OLD_ORDER_ENTRY(4,750,'2022-05-25','DELIVERED','5,6');
CALL OLD_ORDER_ENTRY(5,800,'2022-05-25','DELIVERED','6,7,8');

CALL OLD_ORDER_ENTRY(6,500,'2022-06-07','DELIVERED','8,9');
CALL OLD_ORDER_ENTRY(4,250,'2022-06-10','DELIVERED','9');
CALL OLD_ORDER_ENTRY(2,300,'2022-06-11','DELIVERED','10');
CALL OLD_ORDER_ENTRY(5,500,'2022-06-13','DELIVERED','10,11');
CALL OLD_ORDER_ENTRY(4,750,'2022-06-15','DELIVERED','11,12');
CALL OLD_ORDER_ENTRY(3,900,'2022-06-17','DELIVERED', '12,13');
CALL OLD_ORDER_ENTRY(1,650,'2022-06-22','DELIVERED', '13,14');
CALL OLD_ORDER_ENTRY(9,700,'2022-06-27','DELIVERED', '14,15');

CALL OLD_ORDER_ENTRY(5,400,'2022-07-01','DELIVERED', '15,16');
CALL OLD_ORDER_ENTRY(3,500,'2022-07-07','DELIVERED', '17');
CALL OLD_ORDER_ENTRY(6,750,'2022-07-10','DELIVERED', '17,18');
CALL OLD_ORDER_ENTRY(9,400,'2022-07-16','DELIVERED', '18,19');
CALL OLD_ORDER_ENTRY(7,800,'2022-07-19','DELIVERED', '19,20');
CALL OLD_ORDER_ENTRY(2,600,'2022-07-21','DELIVERED', '20,21');
CALL OLD_ORDER_ENTRY(4,550,'2022-07-25','DELIVERED', '21,22');

CALL OLD_ORDER_ENTRY(9,650,'2022-08-02','DELIVERED', '23,24');
CALL OLD_ORDER_ENTRY(7,350,'2022-08-07','DELIVERED', '24');
CALL OLD_ORDER_ENTRY(3,800,'2022-08-07','DELIVERED', '25,26');
CALL OLD_ORDER_ENTRY(1,500,'2022-08-09','DELIVERED', '26,27');
CALL OLD_ORDER_ENTRY(4,600,'2022-08-15','DELIVERED', '28,29');
CALL OLD_ORDER_ENTRY(5,750,'2022-08-22','DELIVERED', '29,30');
CALL OLD_ORDER_ENTRY(6,450,'2022-08-29','DELIVERED', '31,32');

CALL OLD_ORDER_ENTRY(3,400,'2022-09-04','DELIVERED', '33');
CALL OLD_ORDER_ENTRY(5,600,'2022-09-09','DELIVERED', '34,35');
CALL OLD_ORDER_ENTRY(7,350,'2022-09-10','IN_TRANSIT', '35');
CALL OLD_ORDER_ENTRY(9,400,'2022-09-17','IN_TRANSIT', '36');
CALL OLD_ORDER_ENTRY(1,600,'2022-09-17','IN_PRODUCTION','NOT_ASSIGNED');
CALL OLD_ORDER_ENTRY(4,900,'2022-09-22','IN_PRODUCTION','NOT_ASSIGNED');
CALL OLD_ORDER_ENTRY(2,700,'2022-09-23','PROCESSING','NOT_ASSIGNED');
CALL NEW_ORDER_ENTRY(8,750, '2022-09-26', @NEW_ONUM);
CALL NEW_ORDER_ENTRY(6,600,'2022-09-28',@NEW_ONUM);
...
BEGIN
    ...
    OPEN CU ;
		CU_LOOP:LOOP
            ...
            UPDATE OLD_SALARY SET COMM=COM*ORD_TOT, TOTALSAL=TOT+(COM*ORD_TOT) WHERE ENUM=SNO AND MONTH=MON AND YEAR=YEAR;
...
BEGIN
    ...
    DECLARE SAL_EXP FLOAT DEFAULT 0;
    DECLARE H INT DEFAULT 0;
    DECLARE CU CURSOR FOR 
    ...
    OPEN CU ;
        ...
        END LOOP CU_LOOP;
        INSERT INTO INCM_EXP_TALLY VALUES ('E', SAL_EXP, SYSDATE(), CONCAT(MON ,'/',YEAR,'--', ' SALARY OF EMPLOYEES'));
    CLOSE CU;
...
DELIMITER //
CREATE PROCEDURE MONTHLY_EXP(MON INTEGER, YEAR INTEGER, ELE INTEGER, RENT INTEGER, MISC INTEGER)
BEGIN
	DECLARE EXP FLOAT;
    DECLARE INC FLOAT;
    ...
    IF(C>0) THEN
		DELETE FROM INCM_EXP_TALLY WHERE REMARK LIKE CONCAT("%",MON ,'/',YEAR,"%");
    END IF;
    ...
    INSERT INTO INCM_EXP_TALLY VALUES ('T', INC, SYSDATE(), CONCAT(MON ,'/',YEAR,'--', ' TOTAL INCOME'));
    SELECT SUM(AMT) INTO EXP FROM INCM_EXP_TALLY 
		WHERE HEAD='E' AND MONTH(ENTRY_DATE)=MON AND YEAR(ENTRY_DATE)=YEAR ;
	SELECT AMT INTO SALARY FROM INCM_EXP_TALLY WHERE REMARK=CONCAT(MON ,'/',YEAR,'--', ' SALARY OF EMPLOYEES');
	SET EXP=EXP+ELE+RENT+MISC+SALARY;
    INSERT INTO INCM_EXP_TALLY VALUES ('X', EXP, SYSDATE(), CONCAT(MON ,'/',YEAR,'--', ' TOTAL EXPENSE'));
...
CALL MONTHLY_SAL(2022, 5);
CALL MONTHLY_EXP(5, 2022, 50000, 65000, 65000);
CALL MONTHLY_SAL(2022, 6);
CALL MONTHLY_EXP(6, 2022, 51000, 58000, 60000);
CALL MONTHLY_SAL(2022, 7);
CALL MONTHLY_EXP(7, 2022, 55000, 60000, 62000);
CALL MONTHLY_SAL(2022, 8);
CALL MONTHLY_EXP(8, 2022, 52000, 66500, 65000);
