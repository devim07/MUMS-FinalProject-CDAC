...
(
    ...
    CONSTRAINT CH_LOGIN_ROLE CHECK (ROLE IN ('ADMIN', 'CUSTOMER', 'EMPLOYEE')),
	ID VARCHAR(4) NOT NULL
);

INSERT INTO LOGIN (USERNAME, PASSWORD, ROLE, ID) VALUES
("PP01", "123@P", "ADMIN", "P001"),
("PP02", "123@P", "EMPLOYEE", "P002"),
("CC01", "123@C", "CUSTOMER", "1"),
("SS02", "123@S", "EMPLOYEE", "S002");
